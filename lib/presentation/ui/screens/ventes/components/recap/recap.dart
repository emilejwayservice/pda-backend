...
class RecapScreen extends StatefulWidget {
  ...
  static Widget page(VentesDirectBloc bloc){
...
class _RecapScreenState extends State<RecapScreen> {
                ...
                return Column(
                  children: [
                    ...
                    MyCustomButton(
                        name: "Ajouter",
                      color: Colors.green,
                      isLoading:state.addVenteStatus==AppStatus.loading,
                      isDisabled: state.addVenteStatus==AppStatus.success,
  ...
  void listener(BuildContext context, VentesDirectState state) {
    if(state.addVenteStatus==AppStatus.error){
    ...
    }else if(state.addVenteStatus==AppStatus.success){
  ...
  void addCommandClick() {
    BlocProvider.of<VentesDirectBloc>(context).add(AddVente());
  }
}
